...
const emcc=process.env.EMCC??join(root,'tmp/emsdk/upstream/emscripten/emcc.py');
const python=process.env.EMSDK_PYTHON??join(root,'tmp/emsdk/python/3.13.3_64bit/python.exe');
